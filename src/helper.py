...
def extract_full_dataset(dataloader) -> tuple[torch.Tensor, torch.Tensor]:
    """
    Extracts all batches from a DataLoader and concatenates them into single tensors.
    ...
    Returns:
        tuple[torch.Tensor, torch.Tensor]: A tuple containing:
            - A tensor of all images
            - A tensor of all corresponding labels
    """
    images_list = []
    labels_list = []
